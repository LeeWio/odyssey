...
const THEME_MODES: readonly ThemeModeDefinition[] = [
  {
    ...
    theme: "light",
    icon: SunMaxFillIcon,
    keywords: ["bright", "white", "day", "白天", "明亮"],
  },
  {
    id: "dark",
    title: "Dark",
    theme: "dark",
    icon: MoonFillIcon,
    keywords: ["night", "black", "darkness", "深色", "黑夜"],
  },
  {
    id: "system",
    title: "System",
    ...
    keywords: ["auto", "device", "os", "默认", "自动", "系统"],
  },
];
...
const THEME_VARIANTS: readonly ThemeVariantDefinition[] = [
  {
    ...
    icon: GearIcon,
    keywords: ["base", "standard", "reset", "默认"],
  },
  {
    variant: "glass",
    title: "Glass",
    ...
    icon: SparklesIcon,
    keywords: ["frosted", "transparent", "blur", "玻璃"],
  },
  {
    variant: "mouve",
    title: "Mouve",
    ...
    icon: DisplayFillIcon,
    keywords: ["soft", "editorial", "mauve", "紫灰"],
  },
  {
    variant: "brutalism",
    title: "Brutalism",
    ...
    icon: TargetIcon,
    keywords: ["bold", "graphic", "sharp", "野兽派"],
  },
];
  ...
  return useMemo(() => {
    ...
    const variantCommands = THEME_VARIANTS.map((variant, index) =>
      createActionCommand({
        ...
        title: `Apply ${variant.title} Theme`,
        description:
          currentVariant === variant.variant ? "Current theme variant" : variant.description,
        icon: variant.icon,
        category: "System",
        source: "theme",
        order: 1100 + index,
