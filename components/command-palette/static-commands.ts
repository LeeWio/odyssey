...
export const STATIC_COMMANDS: readonly CommandItem[] = [
  ...
  createNavigationCommand({
    ...
    title: "Demo · Focus Schedule",
    description: "Open the seed calendar demo — local UI only, not synced",
    icon: ClockIcon,
    category: "System",
    source: "navigation",
    order: 7,
  ...
  createNavigationCommand({
    ...
    title: "Demo · Codebase Map",
    description: "Browse a curated sample tree of Odyssey — not a live repository mirror",
    icon: GearIcon,
    category: "System",
    source: "navigation",
    order: 8,
  ...
  createNavigationCommand({
    ...
    description: "Open the curated onboarding stepper — illustrative walkthrough",
    icon: PersonsIcon,
    category: "System",
    source: "navigation",
    order: 10,
  ...
  createNavigationCommand({
    ...
    title: "Demo · Recruiter Sandbox",
    description: "Open the recruiter evaluation playground — experimental UI",
    icon: PersonsIcon,
    category: "System",
    source: "navigation",
    order: 11,
  ...
  createNavigationCommand({
    id: "navigate-copilot",
    title: "Demo · Odyssey Copilot",
    description: "Open the scripted site guide — keyword replies, not a live model",
    icon: SparklesIcon,
    category: "AI",
    source: "navigation",
    order: 0,
    keywords: ["copilot", "ai", "chat", "assistant", "ask", "bot", "guide", "helper", "demo"],
    intent: CommandIntent.NAVIGATE,
