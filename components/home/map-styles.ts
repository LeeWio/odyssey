...
// full vector styles (dark/positron) reference glyphs/sprites that currently 404, which
// keeps MapLibre's loading veil spinning even after the globe and Flight Paths layers
// are ready to draw.
...
// Dark theme: match OpenFreeMap dark's near-black backdrop and tone down the light
// Natural Earth raster so the globe reads as dark instead of washed-out white.
...
export const mapWorkerUrl = `https://cdn.jsdelivr.net/npm/maplibre-gl@${getVersion()}/dist/maplibre-gl-worker.mjs`;
