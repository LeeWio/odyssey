...
import { Modal, ScrollShadow, type UseOverlayStateReturn } from "@heroui/react";
    ...
    <Modal isOpen={state.isOpen} onOpenChange={state.setOpen}>
      <Modal.Backdrop>
        <Modal.Container size="cover">
          <Modal.Dialog className="[scrollbar-width:none] [&::-webkit-scrollbar]:hidden bg-background/45 backdrop-blur-2xl backdrop-saturate-[1.6] overflow-y-visible">
            <Modal.Header>
              {/* <Modal.Icon className="bg-default text-foreground">
              </Modal.Icon>
              <Modal.Heading>Welcome to HeroUI</Modal.Heading> */}
            </Modal.Header>
            <Modal.Body className="[&::-webkit-scrollbar]:hidden overflow-visible ">
              <Plate editor={editor}>
                <PlateContent
                  autoFocusOnEditable
