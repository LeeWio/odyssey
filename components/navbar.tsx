    ...
    >
            ...
            >
              <div className="flex items-center gap-4 text-left">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-muted mt-0.5 text-[10px] font-medium">Philosophy & Musings.</p>
                </div>
              </div>
            </Dropdown.Item>
            <Dropdown.Item
            ...
            >
              <div className="flex items-center gap-4 text-left">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-muted mt-0.5 text-[10px] font-medium">Fragments of Routine.</p>
                </div>
              </div>
            </Dropdown.Item>
          </Dropdown.Menu>
      ...
      <Dropdown>
        <Dropdown.Trigger className="rounded-full">
          <MotionAvatar size="sm" variants={itemVariants}>
            <Avatar.Image
              alt="Junior Garcia"
