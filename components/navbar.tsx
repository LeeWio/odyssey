...
export const Navbar = () => {
  ...
  const handleLogin = () => {
    // Basic credential setting; async behavior to be handled by RTK Query later
    dispatch(
      setCredentials({
        id: "usr_123",
  ...
  return (
    ...
    >
      ...
      {/* Center: Nav (Each item animated individually) */}
      ...
      {/* Right: Actions */}
      <div className="border-border/50 flex items-center gap-4 border-l pl-6 min-w-[140px] justify-end">
        <AnimatePresence mode="wait">
          {isAuthenticated && user ? (
            ...
            >
              ...
              <Button size="sm" variant="flat" onPress={handleLogout}>Log out</Button>
            </motion.div>
          ) : (
            <motion.div 
              key="guest" 
            ...
            >
              ...
              <Button size="sm" onPress={handleLogin}>Get Started</Button>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
