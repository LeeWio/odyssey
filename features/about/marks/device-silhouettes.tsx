...
export function MacSilhouette({ className }: MarkProps) {
  return (
    <svg viewBox="0 0 72 56" className={cn("text-foreground", className)} aria-hidden="true" fill="currentColor">
...
export function PhoneSilhouette({ className }: MarkProps) {
  return (
    <svg viewBox="0 0 36 64" className={cn("text-foreground", className)} aria-hidden="true" fill="currentColor">
...
export function BudsSilhouette({ className }: MarkProps) {
  return (
    <svg viewBox="0 0 56 40" className={cn("text-foreground", className)} aria-hidden="true" fill="currentColor">
