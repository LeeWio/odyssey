...
import { cn, tv, type VariantProps } from "@heroui/styles";
...
type HeadingElementProps = PlateElementProps & VariantProps<typeof headingVariants>;
...
export function HeadingElement({
  ...
  return (
    <PlateElement
      ...
      attributes={{
        ...attributes,
        className: cn(headingVariants({ variant }), attributes?.className),
      }}
    >
      {children}
    </PlateElement>
