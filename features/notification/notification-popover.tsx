...
import { Badge, Button, Chip, Popover, ScrollShadow, Skeleton, Tabs, Tooltip } from "@heroui/react";
...
function NotificationPopoverEmptyState({ unreadOnly }: { unreadOnly: boolean }) {
  return (
    <div className="flex min-h-60 items-center justify-center px-6 py-8">
      <EmptyState size="sm">
        <EmptyState.Header>
